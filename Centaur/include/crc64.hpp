...
#ifndef CENTAUR_CRC64_HPP
#define CENTAUR_CRC64_HPP

/// THIS SOURCE CODE FILE IS BASED ON THE WORK OF Ivor Wanders FOR COMPUTATION OF CRC32 AT COMPILE TIME
...
namespace CENTAUR_NAMESPACE::crc64
{
    ...
    C_NODISCARD constexpr uint64_t compute(const char *const data, uint64_t len, uint64_t crc = 0)
    {
        if (len == 0)
            return 0;
