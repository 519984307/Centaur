...
"sameAddress":{"type":"boolean"},"depositDust":{"type":"string"},"estimatedArrivalTime":{"type":"integer"},"busy": {"type": "boolean"},"country":{"type": "string"}},"additionalProperties":false,
"required":["network","coin","withdrawIntegerMultiple","isDefault","depositEnable",
