////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//  WSSpotBinanceAPI.cpp

/**
 * @file  WSSpotBinanceAPI.cpp
 * @brief
 *
...
trader::api::ws::WSSpotBinanceAPI::WSSpotBinanceAPI()
{
    // Init protocol
...
void trader::api::ws::WSSpotBinanceAPI::subscribe(const std::string &stream, const int &id)
{
    std::string subscribe = fmt::format(R"({{"method": "SUBSCRIBE","params":["{}"],"id":{}}})", stream, id);
    sendData(subscribe);
}

void trader::api::ws::WSSpotBinanceAPI::unsubscribe(const std::string &stream, const int &id)
{
    std::string unsubscribe = fmt::format(R"({{"method": "UNSUBSCRIBE","params":["{}"],"id":{}}})", stream, id);
    sendData(unsubscribe);
}

void trader::api::ws::WSSpotBinanceAPI::run(const std::string &endpoint, const bool &multipleStreams)
{
...
void trader::api::ws::WSSpotBinanceAPI::terminate()
{
    if (!m_running)
        return;
    m_terminate = true;
...
std::variant<std::string, int> trader::api::ws::WSSpotBinanceAPI::subscribeKline(const std::string &symbol, const BinanceTimeIntervals &interval)
{
...
std::variant<std::string, int> trader::api::ws::WSSpotBinanceAPI::subscribeIndividualMiniTicker(const std::string &symbol)
{
    std::string stream = fmt::format("{}@miniTicker", symbolToLower(symbol));
    SUBSCRIBE_METHOD(stream);
}

int trader::api::ws::WSSpotBinanceAPI::unsubscribeIndividualMiniTicker(const std::string &symbol)
{
    std::string stream = fmt::format("{}@miniTicker", symbolToLower(symbol));
    UNSUBSCRIBE_METHOD(stream);
}

std::variant<std::string, int> trader::api::ws::WSSpotBinanceAPI::subscribeAllMarketMiniTickers()
{
    std::string stream = "!miniTicker@arr";
    SUBSCRIBE_METHOD(stream);
}

std::variant<std::string, int> trader::api::ws::WSSpotBinanceAPI::subscribeIndividualSymbolTicker(const std::string &symbol)
{
    std::string stream = fmt::format("{}@ticker", symbolToLower(symbol));
    SUBSCRIBE_METHOD(stream);
}

std::variant<std::string, int> trader::api::ws::WSSpotBinanceAPI::subscribeAllMarketTickers()
{
    std::string stream = "!ticker@arr";
    SUBSCRIBE_METHOD(stream);
}

std::variant<std::string, int> trader::api::ws::WSSpotBinanceAPI::subscribeIndividualSymbolBookTickerStreams(const std::string &symbol)
{
    std::string stream = fmt::format("{}@bookTicker", symbolToLower(symbol));
    SUBSCRIBE_METHOD(stream);
}

std::variant<std::string, int> trader::api::ws::WSSpotBinanceAPI::subscribeAllBookTickerStream()
{
    std::string stream = "!bookTicker";
    SUBSCRIBE_METHOD(stream);
}

std::variant<std::string, int> trader::api::ws::WSSpotBinanceAPI::subscribePartialBookDepth(const std::string &symbol, const int &levels, const int &update)
{
...
std::variant<std::string, int> trader::api::ws::WSSpotBinanceAPI::subscribeDiffBookDepth(const std::string &symbol, const int &update)
{
    assert(update == 1000 || update == 100);
...
int trader::api::ws::WSSpotBinanceAPI::unsubscribeDiffBookDepth(const std::string &symbol, const int &update)
{
    assert(update == 1000 || update == 100);
    std::string stream = fmt::format("{}@depth@{}ms", symbolToLower(symbol), update);
    UNSUBSCRIBE_METHOD(stream)
...
void trader::api::ws::WSSpotBinanceAPI::subscribe([[maybe_unused]] const bool &result, [[maybe_unused]] const int &id)
{
}

void trader::api::ws::WSSpotBinanceAPI::unsubscribe([[maybe_unused]] const bool &result, [[maybe_unused]] const int &id)
{
}

void trader::api::ws::WSSpotBinanceAPI::kline([[maybe_unused]] const std::string &symbol, [[maybe_unused]] const uint64_t &eventTime, [[maybe_unused]] const BinanceTimeIntervals &interval, [[maybe_unused]] const Candlestick &cs)
{
}

void trader::api::ws::WSSpotBinanceAPI::individualSymbolMiniTicker([[maybe_unused]] const std::string &symbol, [[maybe_unused]] const uint64_t &eventTime, [[maybe_unused]] const StreamIndividualSymbolMiniTicker &ticker)
{
}

void trader::api::ws::WSSpotBinanceAPI::allMarketMiniTickers([[maybe_unused]] const std::multimap<std::string, std::pair<uint64_t, StreamMarketMiniTickers>> &mm)
{
}

void trader::api::ws::WSSpotBinanceAPI::individualSymbolTicker([[maybe_unused]] const std::string &symbol, [[maybe_unused]] const uint64_t &eventTime, [[maybe_unused]] const StreamIndividualSymbolTicker &ticker)
{
}

void trader::api::ws::WSSpotBinanceAPI::allMarketTickers([[maybe_unused]] const std::multimap<std::string, std::pair<uint64_t, StreamMarketTickers>> &mm)
{
}

void trader::api::ws::WSSpotBinanceAPI::bookTicker([[maybe_unused]] const std::string &symbol, [[maybe_unused]] const uint64_t &eventTime, [[maybe_unused]] const StreamBookTicker &ticker)
{
}

void trader::api::ws::WSSpotBinanceAPI::depthUpdate([[maybe_unused]] const std::string &symbol, [[maybe_unused]] const uint64_t &eventTime, [[maybe_unused]] const StreamDepthUpdate &sdp)
{
}

void trader::api::ws::WSSpotBinanceAPI::sendData(const std::string &msg)
{
...
void trader::api::ws::WSSpotBinanceAPI::receivedData(const std::string &msg)
{
    ...
    try
    {
        ...
        if (jsonDoc.FindMember("result") != jsonDoc.MemberEnd())
        {
            ...
            bool result = jsonDoc["result"].IsNull() ? true : false;
...
int trader::api::ws::WSSpotBinanceAPI::eventManager(struct lws *wsi, enum lws_callback_reasons reason, void *user, void *in, size_t len)
{
    auto client = reinterpret_cast<trader::api::ws::WSSpotBinanceAPI *>(user);
...
int trader::api::ws::WSSpotBinanceAPI::randNumber(const bool &subscribe)
{
